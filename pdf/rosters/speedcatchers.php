...
$sql = mysqli_prepare($link, "select fname from dbcworkshopnametags where position = 'Speed Catcher'");
...
while ($row = mysqli_fetch_array($result)) {
    ...
    $docname = '2023_DBC_Speed Catchers Roster.pdf';
