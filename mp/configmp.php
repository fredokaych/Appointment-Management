...
class Config {
    ...
    public function __construct( $configs ) {
        ...
        $defaults = array(
			...
			"validation_url" => $base . "/mp/validate.php",
			"confirmation_url" => $base . "/mp/confirm.php",
			"callback_url" => $base . "/mp/reconcile.php",
			"timeout_url" => $base . "/mp/timeout.php",
			"results_url" => $base . "/mp/results.php",
        );
