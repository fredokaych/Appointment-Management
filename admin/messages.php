...
if(isset($_GET['del'])){
	mysqli_query($link,"delete from id17137158_pmsproject.adminmessages where id = '".$_GET['id']."'");
}
if(isset($_GET['con'])){
	$isread=1;
	mysqli_query($link,"update id17137158_pmsproject.adminmessages set IsRead='$isread' where id = '".$_GET['id']."'");
}
if(isset($_GET['unr'])){
	$isread=0;
	mysqli_query($link,"update id17137158_pmsproject.adminmessages set IsRead='$isread' where id = '".$_GET['id']."'");
...
<html>
<head>
<title>Admin | Internal Messages</title>
<meta charset="utf-8">
...
<div class=" bg-light container-fluid">
	...
	<div class="row">
		<div class="col-lg-6">
			<h3 id="welcome-header">Manage | Internal Messages</h3>
			...
			<div class="row">
				...
				<div class="col">
					...
					<div class="text-right">
						<a style="color:white" href="create-message.php"><button type="button" class="btn btn-success" name="update">Create New Message</button></a>
					</div>
				</div>
			</div>
	...
	<div class="table-responsive">
		<table class="table table-bordered  table-hover table-bordered" id="sample-table-1">
			...
			<tbody id="mymessages">
				...
				$sql = mysqli_prepare( $link, "select * from adminmessages where adminID = ".$_SESSION['id']." and IsRead = 0 order by id desc" );
