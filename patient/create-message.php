            ...
            <table class="table table-bordered  table-hover" id="sample-table-1">
				<tbody>
					<form name="query" method="post">
						...
						<tr>
							<th>Email Address</th>
							<td><input type="email" id="email" name="email" class="form-control"  onBlur="checkemailAvailability()" placeholder="Enter Email" value="" required></td>
						</tr>
						...
						<tr>
							<th>Title</th>
							<td><?php ?><input type="text" id="title" name="title" class="form-control" placeholder="Title" value="" required></td>
						</tr>
