...
if(isset($_GET['del'])){
	mysqli_query($link,"delete from id17137158_pmsproject.patientmessages where id = '".$_GET['id']."'");
}
if(isset($_GET['con'])){
	$isread=1;
	mysqli_query($link,"update id17137158_pmsproject.patientmessages set IsRead='$isread' where id = '".$_GET['id']."'");
}
if(isset($_GET['unr'])){
	$isread=0;
	mysqli_query($link,"update id17137158_pmsproject.patientmessages set IsRead='$isread' where id = '".$_GET['id']."'");
	...
	<div class="table-responsive">
		<table class="table table-bordered  table-hover table-bordered" id="sample-table-1">
			...
			<tbody id="mymessages">
				...
				$sql = mysqli_prepare( $link, "select * from patientmessages where patientID = ".$_SESSION['id']." and IsRead = 0 order by id desc");
